    ...
    public QuickMenu() {
        ...
        nothing.AddCallback(data -> {
            ...
            previous = QuickChat.ShowChat(new QuickChat.Msg[]{
                ...
                new QuickChat.Msg("\n §lSelection Area\n"),
                new QuickChat.Msg("§e  [Clear] ", new ClickEvent(ClickEvent.Action.RUN_COMMAND, "$select none")),
                new QuickChat.Msg("§e  [Toggle See Through] ", new ClickEvent(ClickEvent.Action.RUN_COMMAND, "$seethrough")),
                new QuickChat.Msg("\n §lExtend Selection Area\n"),
